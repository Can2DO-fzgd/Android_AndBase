...
public class ViewPlayActivity extends AbActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		mPlayText1.setText("1111111111111");
		mPlayImage1.setBackgroundResource(R.drawable.guide_pic1);
		...
		mPlayText2.setText("2222222222222");
		mPlayImage2.setBackgroundResource(R.drawable.guide_pic2);
		
		final View mPlayView3 = mInflater.inflate(R.layout.play_view_item, null);
		ImageView mPlayImage3 = (ImageView) mPlayView3.findViewById(R.id.mPlayImage);
		TextView mPlayText3 = (TextView) mPlayView3.findViewById(R.id.mPlayText);
		mPlayText3.setText("33333333333333333");
		mPlayImage3.setBackgroundResource(R.drawable.guide_pic2);
        ...
        mAbAutoPlayView.addView(mPlayView3);
